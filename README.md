...
Overall, adding the temperatures signal eventually helps the learning model converges better, especially for predicting the daily "Confirmed" case. We see that after training, the temperature added model has lower training and validation MSE, and also predicts more accurately. 
